...
import com.example.madhukurapati.staysafe.activity.RideDetailActivity;
...
public abstract class RidesListFragment extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        mRecycler = (RecyclerView) rootView.findViewById(R.id.rides_messages_list);
            ...
            protected void populateViewHolder(final PostViewHolder viewHolder, final Post model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(RideDetailActivity.EXTRA_RIDE_KEY, rideKey);
